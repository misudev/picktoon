...
insert into keyword (id, keyword_type, keyword_value, ordering) values (26, 4, "학교", 1);
insert into keyword (id, keyword_type, keyword_value, ordering) values (27, 4, "범죄", 1);
insert into keyword (id, keyword_type, keyword_value, ordering) values (28, 4, "귀신", 1);
...
values (1, "굿바이 사돈", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/goodbyeinlaw", 155, "사돈 사이가 된 원수지간 남녀, 때마침 모든 걸 되돌릴 수 있는 기회가 눈앞에 찾아오는데!", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (2, "일단 질러! 질렐루야", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/impulsebuyer", 100, "야미작가의 신작. 소소한 생활지름의 세계로 오라~", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (3, "겟 레디 위드 미", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/getreadywithme", 3000, "뷰티 크리에이터를 제안하는 지욱과, 관심 1도 없는 그림의 메이크업 로맨스", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (4, "왕 그리고 황제", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/getreadywithme", 100, "영혼이 바뀐 고종과 태종, 그들은 조선을 바꿀 수 있을까?", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (5, "노인의 집", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/HeavensSoul", 200, "매우 규칙적이고 성실하게 삶을 허비하는 노인의 집에 한 아이가 들어왔다.", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (6, "헤븐즈 소울", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/HeavensSoul", 1000, "괴생명체 크리쳐의 공격에 맞서는 소녀들의 이야기", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (7, "프레너미", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/Frenemy", 3000, "거만한 천재 소년과 심약한 은둔 고수와의 만남, 재능과 노력만으론 최고가 될 수 없다!", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (8, "이웃잔혹사", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/neighbordeath", 11, "복권 당첨금을 둘러싸고 이웃 간에 벌어지는 잔혹 드라마", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (9, "우리 남매의 일상은", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/brothersister", 155, "대한민국 어디에나 있을법한 남매들의 화려한 일상!", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (10, "풍검", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/windsword", 100, "마계의 힘으로 인간계를 없애려는 자들과 막으려는 자들의 치열한 싸움", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (11, "천연", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/heavencouple", 30, "돌이킬 수 없는 과거와 얽히는 현재. 그리고, 유동의 미래", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (12, "껍데기", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/shell", 10000, "예뻐지고 싶은 태희와 성형외과 의사 도하, 그들은 껍데기만으로 행복해질 수 있을까?", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (13, "퀴퀴한 일기", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/ficnonfic", 155, "사돈 사이가 된 원수지간 남녀, 때마침 모든 걸 되돌릴 수 있는 기회가 눈앞에 찾아오는데!", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (14, "유사과학 탐구영역", "연재중", "전체관람가", "http://webtoon.daum.net/webtoon/view/PseudoScience", 1, "즈질스럽고 퀴퀴한 언니의 쿰쿰한 일상다반사", 2);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (15, "마음의 소리", "연재중", "전체관람가", "https://comic.naver.com/webtoon/list.nhn?titleId=20853&weekday=tue",123, "솔직 담백 최강의 개그 만화", 1);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (16, "대학일기", "완결", "전체관람가", "https://comic.naver.com/webtoon/list.nhn?titleId=679519&weekday=mon", 230, "로망이 꽃피는 캠퍼스는 없다. 극사실주의에 기반한 너무나 현실적인 우리의 대학일기", 1);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (17, "유미의 세포들", "연재중", "전체관람가", "https://comic.naver.com/webtoon/list.nhn?titleId=651673", 123, "유미는 지금 무슨 생각을 하고 있을까? 그녀의 머릿속에서 바쁘게 움직이는 세포들 이야기!", 1);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (18, "기기괴괴", "연재중", "전체관람가", "https://comic.naver.com/webtoon/list.nhn?titleId=557672", 18, "<절벽귀> 오성대 작가의 신작 옴니버스 미스테리 스릴러.기묘하고 괴상한 이야기들.", 1);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
values (19, "좀비딸", "연재중", "전체관람가", "https://comic.naver.com/webtoon/list.nhn?titleId=715772&weekday=thu", 189, "나의 딸은 좀비다. 이 세상 마지막 남은 유일한 좀비...", 1);
insert into webtoon (id, title, state, see_age, link, subscription, description, platform_id)
...
insert into webtoon_state (id, update_state, updated_date, total_count, webtoon_id) values (15, 1, "2019-03-18 17:51:20", "1161화", 15);
insert into webtoon_state (id, update_state, updated_date, total_count, webtoon_id) values (16, 0, "2019-03-17 15:51:20", "290화", 16);
insert into webtoon_state (id, update_state, updated_date, total_count, webtoon_id) values (17, 0, "2019-03-15 02:30:30", "362화", 17);
insert into webtoon_state (id, update_state, updated_date, total_count, webtoon_id) values (18, 0, "2019-03-14 01:30:30", "254화", 18);
